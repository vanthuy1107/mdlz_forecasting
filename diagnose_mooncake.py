...
def check_model_retraining():
    ...
    model_path = Path("outputs/MOONCAKE/models/best_model.pth")
    ...
    scaler_path = Path("outputs/MOONCAKE/models/scaler.pkl")
    metadata_path = Path("outputs/MOONCAKE/models/metadata.json")
